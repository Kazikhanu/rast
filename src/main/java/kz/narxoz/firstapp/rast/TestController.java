package kz.narxoz.firstapp.rast;

import kz.narxoz.firstapp.rast.repo.UserRepository;
import kz.narxoz.firstapp.rast.model.User;
...
public class TestController {
    ...
    public String showUserList(@RequestParam(name="email", required = false, defaultValue ="")String email,
                               ...
                               @RequestParam(name="name5", required = false, defaultValue ="")String name5,Model model)
    {
